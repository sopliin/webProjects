...
<body>
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i> Cambiar datos</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="index.html"><i class="align-middle me-1" data-feather="settings"></i> Cambiar foto</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="../../PaginaInicioYLoguearse/static/index.html">Cerrar Sesión</a>
						...
						<table class="table table-hover my-0">
							...
							<tbody>
								<tr>
									...
									<td><button class="btn btn-primary btn-sm" onclick="mostrarTabla('sanMartin')">Ir al distrito</button></td>
								</tr>
								<tr>
									<td>La Libertad</td>
									<td><button class="btn btn-primary btn-sm" onclick="mostrarTabla('laLibertad')">Ir al distrito</button></td>
								</tr>
								<tr>
									<td>Comas</td>
									<td><button class="btn btn-primary btn-sm" onclick="mostrarTabla('comas')">Ir al distrito</button></td>
								</tr>
								<tr>
									<td>Independencia</td>
									<td><button class="btn btn-primary btn-sm" onclick="mostrarTabla('independencia')">Ir al distrito</button></td>
								</tr>
							</tbody>
						</table>
					</div>
	...
	<script>
		function mostrarTabla(distrito) {
			const titulos = {
				'sanMartin': 'San Martin de Porres',
