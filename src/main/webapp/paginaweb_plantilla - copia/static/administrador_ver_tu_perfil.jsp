	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Coordinadores</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0wJdLOzpqq8A0RDKqPmxBQ1On12XYtQ1OnQ&s" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Menganito</span>
              </a>			
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="administrador_ver_tu_perfil.html"><i class="align-middle me-1" data-feather="user"></i> Ver perfil</a>
								<!--
								<a class="dropdown-item" href="cambiar-contraseña-administrador.html"><i class="align-middle me-1" data-feather="settings"></i> Cambiar contraseña</a>
								<a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="settings"></i> Cambiar foto</a>
								-->
								<!--
								...
								<div class="dropdown-divider"></div>
								-->
								<a class="dropdown-item" href="pagina_inicio.html">Cerrar Sesion</a>
							</div>
								...
								<div class="card-body">
									...
									<ul class="list-unstyled mb-0">
									  ...
									  <li class="mb-2 position-relative">
										<a href="cambiar_contrasenna.html" class="btn btn-secondary w-100 position-relative text-center">
									  ...
									  <li class="mb-2">
										<a href="administrador_crear_coordinador.html" class="btn btn-success w-100">
